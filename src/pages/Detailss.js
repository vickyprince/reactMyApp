...
const transitionDuration0 = 1000;
const transitionDuration3 = 1000;
const transitionDuration4 = 1000;
          ...
          <div elevation={4} className={classes.paper}>
              ...
              <Box fontWeight="400" m={1} color="text.primary" display="flex" justifyContent="center">
                <Typography component="div" >
                  Please transfer XYZ amount to the below account and fill
                  the details
                        </Typography>
              </Box>
              </div>
              ...
              <Slide direction="right" in={checked} timeout={transitionDuration4}>
              <Box display="flex" m={1} p={1}>
                <TextField
                  variant="outlined"
                  required
